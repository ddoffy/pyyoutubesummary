...
def test_download_specific():
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        ydl_opts = {
            ...
            # "impersonate": "chrome", # Commenting out impersonate for now to see if it was the cause, or maybe print error better
        }

        print(f"Downloading subtitles for {URL} into {temp_dir} with cookies (no impersonate kwarg)...")
        try:
